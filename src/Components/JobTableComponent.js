...
export default class JobTableComponent
    ...
    constructor(props) {
        super(props);
            ...
            // "description": " Bike Courier   Get a taste of freedom on the road with the UK's
            // largest food delivery network.   Become a self-employed Bike Courier and discover a
            // feast of flexible opportunities at Just Eat.   Whether you're a student trying to
            // make some extra cash, or have a bicycle and are looking to get on the road, this is
            // a great opportunity for you to boost your income (and work on your calf muscles
            // too). You can work weekdays or weekends, daytime or evenings, a full schedule or
            // bits here and there - t\u2026", "salary_is_predicted": "1", "latitude": 53.7244,
            // "salary_min": 21214.8, "redirect_url":
